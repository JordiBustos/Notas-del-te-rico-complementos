...
Sea $(a_n)_{n \in \N} \subset \Q$ decimos que tiende a 0 si dado $\varepsilon > 0, \exists n_0 \in \N : |a_n| < \varepsilon, \forall n > n_0$.
Notamos $a_n \to 0$.

\begin{definition}
  Sea $(a_n)_{n \in \N} \subset \Q$. Decimos que la sucesión es de Cauchy $\iff$ dado $\varepsilon > 0, \exists n_0 : \forall n,m > n_0, |a_n - a_m| < \varepsilon$.
\end{definition}

\begin{theorem}
  $(a_n)_{n \in \N} \subset \Q$ es convergente (es decir $a_n - q \to 0, q \in \Q$) $\Rightarrow$ es de Cauchy.
  \begin{proof}
    Dado $\varepsilon > 0, \exists n_0 \in \N : |a_n - q| < \dfrac{\varepsilon}{2}, \forall n > n_0$. \\
...
\begin{theorem}
  ...
  \begin{proof}
    Como $(a_n)_{n \in \N} \subset \Q$ es de Cauchy, eligiendo $\varepsilon = 1$ \\
