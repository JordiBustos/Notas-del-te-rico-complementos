...
Vamos a ver que $a \in \R$ es el límite de alguna subsucesión de $(x_n)_{n \in \N} \iff \forall \varepsilon > 0$ el conjunto $\{ n \in \N : x_n \in (a - \varepsilon, a + \varepsilon) \}$ es subconjunto infinito de $\N$ 
\begin{theorem}
